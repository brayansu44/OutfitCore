"""
Django settings for outfitcore project.
...
SECRET_KEY = 'django-insecure-sev(gxglbve*t7xo=-3m#!!%2w_9r+t9=)&51!q7#36$c$i*8-'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'outfitcore.context_processors.global_context',
...
WSGI_APPLICATION = 'outfitcore.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "OutfitCore Admin",
    "site_brand": "OutfitCore",
